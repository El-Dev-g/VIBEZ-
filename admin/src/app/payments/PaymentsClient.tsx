...
const RevenueChart = dynamic(() => import('../../components/RevenueChart'), {
  ssr: false,
  loading: () => (
    <div className="h-[300px] w-full bg-slate-900/60 border border-white/10 rounded-3xl animate-pulse flex items-center justify-center">
      <p className="text-sm font-black text-slate-400">Loading charts...</p>
    </div>
  )
});
